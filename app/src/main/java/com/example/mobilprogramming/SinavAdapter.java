...
/*
    if (row_index == position) {
        holder.soruKarti.setCardBackgroundColor(Color.GREEN);
    }
    */
...
public void onClick(View view) {
       ...
       sinavSorulari.add(seciliSoru);
       Toast.makeText(inflater.getContext(),"Soru eklendi!",Toast.LENGTH_SHORT).show();
       row_index=position;
       //holder.soruKarti.setCardBackgroundColor(Color.GREEN);
       holder.linearCard.setBackgroundColor(Color.GREEN);
/*
      if(row_index==position) {
         // holder.soruKarti.setBackgroundColor(Color.GREEN);
          holder.linearCard.setBackgroundColor(Color.GREEN);
...
public int getItemCount() {
    ...
    public void writeToFile(Context context,String puan,String sure) throws IOException {
        try {

            OutputStreamWriter writer = new OutputStreamWriter(context.openFileOutput("sinav.txt",MODE_PRIVATE));
...
class MyViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener{
    ...
    public MyViewHolder(View itemView) {
        ...
        linearCard=(LinearLayout)itemView.findViewById(R.id.linearCart);
